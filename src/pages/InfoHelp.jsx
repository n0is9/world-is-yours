  ...
  return (
    <Container maxW='1480px'>
      <div className='flex flex-col'>
        <div
          className='text-custom-black text-35px font-semibold mt-12'
          id='dovidka'
        >
          Довідка
        </div>
        <div className='flex flex-row mb-20 mt-12'>
          ...
          <div className='flex flex-col gap-8'>
            ...
            <p className='text-18px font-semibold'>
              Якщо у вас виникнуть питання або потреба у додатковій допомозі,
              будь ласка, не соромтеся звертатися до нашої служби підтримки. Ми
              готові вам допомогти та зробити ваше перебування в нашому автодомі
              щасливим та комфортним.
            </p>
            <p className='text-18px font-semibold'>
              З повагою, WORLD IS YOURS!
            </p>
          </div>
        </div>
      </div>
