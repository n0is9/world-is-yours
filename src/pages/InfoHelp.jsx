        ...
        <div className="flex flex-row mb-20 mt-12">
          ...
          <div className="flex flex-col gap-8">
            ...
            <p className="text-18px font-semibold">
              Якщо у вас виникнуть питання або потреба у додатковій допомозі, будь ласка, не
              соромтеся звертатися до нашої служби підтримки. Ми готові вам допомогти та зробити
              ваше перебування в нашому автодомі щасливим та комфортним.
            </p>
